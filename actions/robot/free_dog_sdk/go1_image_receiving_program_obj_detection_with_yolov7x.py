...
class camera:
    def __init__(self, cam_id = None, width = 640, height = 480):
        ...
        # https://github.com/AlexeyAB/darknet/blob/master/cfg/yolov7x.cfg
        self.model = cv2.dnn.readNet('models/yolov7x.weights', 'models/yolov7x.cfg')
    ...
    def demo(self):
        ...
        while(True):
            ...
            self.model.setInput(cv2.dnn.blobFromImage(self.frame, 1 / 255.0, size=(640, 640), swapRB=True, crop=False))
