...
STAND_UP, STAND_DOWN, MOVE_FORWARD, MOVE_BACKWARD, MOVE_LEFT, MOVE_RIGHT, TURN_LEFT, TURN_RIGHT, STOP, WAVE_HAND, SHAKE_HAND, HIGH_FIVE, HUG, CLAP, HEART, HANDS_UP take no arguments.
Use ONLY these action names. Do NOT invent other names (SPIN_JUMP, TILT_HEAD_UP, DANCE, MOVE_BACK do not exist).
