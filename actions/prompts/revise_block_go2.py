...
STAND_UP, STAND_DOWN, RECOVERY_STAND, MOVE_FORWARD, MOVE_BACKWARD, MOVE_LEFT, MOVE_RIGHT, TURN_LEFT, TURN_RIGHT, STOP, HELLO, SIT, RISE_SIT, STRETCH, DANCE take no arguments.
Use ONLY these action names. Do NOT invent other names (SPIN_JUMP, TILT_HEAD_UP, MOVE_BACK, FIRST_DANCE do not exist).
