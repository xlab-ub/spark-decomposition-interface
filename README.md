...
Spark turns natural-language instructions from children into decomposed pseudo-code and robot actions. It uses Rasa for dialogue management, LiteLLM for LLM reasoning, and an optional Unitree Go1 robot backend.
...
The following publication reports empirical work that **utilized the Spark decomposition framework**. If you use this codebase in your research, please cite:
...
This repository is a public, configurable release of the decomposition interface. It is related to the Spark system described in that work, but should not be taken as a line-by-line reproduction of the exact study apparatus.
